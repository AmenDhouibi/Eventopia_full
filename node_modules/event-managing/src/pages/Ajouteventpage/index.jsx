...
export default function AjouteventpagePage() {
  return (
    <>
        <header className="absolute left-0 right-0 top-[12.77px] m-auto flex w-[98%] items-center justify-between gap-5 sm:relative sm:flex-col">
          <div className="relative mb-[7px] h-[85px] w-[19%] sm:w-full">
            <Img
              src="images/img_frame.svg"
              alt="image"
              className="absolute left-[0.00px] top-[0.00px] m-auto h-[75px] w-[75px]"
            />
            <Text size="lg" as="p" className="absolute bottom-[-0.51px] right-[0.25px] m-auto text-center lowercase">
              eventopia
            </Text>
          </div>
          <Img src="images/img_frame_blue_gray_900.svg" alt="image_one" className="h-[45px] w-[5%] sm:w-full" />
        </header>
        <div className="absolute bottom-[6%] left-[35%] m-auto h-[660px] w-[40%]">
  <div className="absolute bottom-[0.00px] right-[0.00px] m-auto flex flex-col items-center rounded-[20px] bg-blue_gray-100_7f p-[5px] shadow-xs sm:p-3 w-full">
    ...
    <div size=""className="mt-[5px] flex flex-col items-start w-full">
